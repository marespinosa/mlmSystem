                            ...
                            <div class="control-payments custom-radio">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <select id="citybelongto" name="citybelongto" style=" padding: 10px; border-radius:999px">
                                    <option value=""> </option>
                                    <option value="Abdullah Lilangan - Cotabato">Abdullah Lilangan - Cotabato City</option>
                                    <option value="Berlin Penida - Digos City">Berlin Penida - Digos City</option>
                                    <option value="Dr. Maribeth Dr. Edgar Salvani - Davao City">Dr. Maribeth Dr. Edgar Salvani - Davao City</option>
                                    <option value="Josephine Morales - Mati City">Josephine Morales - Mati City</option>
                                    <option value="Mylaine Arado - Davao Del Norte">Mylaine Arado - Davao Del Norte</option>
                                    <option value="Raquel Balde - Davao City">Raquel Balde - Davao City</option>
                                    <option value="Rosalie Echavez - Koronadal City">Rosalie Echavez - Koronadal City</option>
                                    <option value="Siony Montanez - Davao City">Siony Montanez - Davao City</option>
                                    <option value="Synthia Ormar - General Santos City">Synthia Ormar - General Santos City</option>
                                    <option value="Maria Melona Egos - Davao City">Maria Melona Egos - Davao City</option>
                                    <option value="Marissa Ternio - Kidapawan City">Marissa Ternio - Kidapawan City</option>
                                    <option value="hery Cejudo Molave - Zamboanga Del Sur">Chery Cejudo Molave - Zamboanga Del Sur</option>
                                </select>
