    ...
    <div class="container">
        <div class="row py-5">
            ...
            <div class="col-md-8 order-md-1">
                ...
                <form action="{{ route('checkout.store') }}" method="POST" class="checkoutform">
                    @csrf
                ...
                <form class="needs-validation" novalidate>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="lastName" value="{{ $user->lastname }}" class="form-control" id="lastName" placeholder="" value="" required>
                            <div class="invalid-feedback">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="phonenumber" value="{{ $user->phoneNumber }}" class="form-control" id="email" placeholder="you@example.com">
                        <div class="invalid-feedback">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="address" value="{{ $user->presentAddress }}" class="form-control" id="address" placeholder="1234 Main St" required>
                        <div class="invalid-feedback">
